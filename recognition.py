	...
	while 1:
		...
		if len(contours) > 0:
			...
			if count_defects == 1:
				...
				cv2.imwrite('/home/Vandi/Downloads/Hand_Gesture_Recognition-master/img/Uncompressed_2.jpg', img, [cv2.IMWRITE_JPEG_QUALITY, 100])
			elif count_defects==0:
				cv2.putText(img,"THIS IS 1", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
				cv2.imwrite('/home/Vandi/Downloads/Hand_Gesture_Recognition-master/img/Uncompressed_1.jpg', img, [cv2.IMWRITE_JPEG_QUALITY, 100])
			elif count_defects == 2:
				cv2.putText(img, "THIS IS 3", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
				cv2.imwrite('/home/Vandi/Downloads/Hand_Gesture_Recognition-master/img/Uncompressed_3.jpg', img, [cv2.IMWRITE_JPEG_QUALITY, 100])
			elif count_defects == 3:
				cv2.putText(img,"This is 4", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
				cv2.imwrite('/home/Vandi/Downloads/Hand_Gesture_Recognition-master/img/Uncompressed_4.jpg', img, [cv2.IMWRITE_JPEG_QUALITY, 100])
			elif count_defects == 4:
				cv2.putText(img,"Hi There!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
